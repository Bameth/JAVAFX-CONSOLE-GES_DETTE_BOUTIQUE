...
public class Menu {
    ...
    public static int displayBoutiquierMenu() {
        ...
        System.out.println("8-Lister les demandes de dettes en cours ou annuler");
        System.out.println("9-Accepter ou Annuler une demande de dette");
        System.out.println("10-Afficher toutes les dettes");
        System.out.println("11-PAIEMENT DETTE");
